...
function codecForTxt(it, txt) {
    console.log(txt);
    let spd = it.dataset.speed;
    $(it).codex({
        effect:"charbychar",
...
let codexTxt = [...document.querySelectorAll('.number-rev')];

function codexTextOnReveal() {
    if (codexTxt.length) {

        codexTxt.forEach((btn) => {
            let origText = btn.dataset.txt;
